...
public final class MainActivity extends Activity {
    ...
    private void showController(String address, String pairingPin) {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " TexiolDexkMobile/2.1.2");
            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    for (int i = 0; i < candidates.length() && i < 8; i++) {
                        ...
                        connection.setRequestProperty("User-Agent", "TexiolDexk-Mobile/2.1.2 LAN-Probe");
